...
object SemanticFixtures {
    ...
    private fun numericFixtures(): List<Case> =
        buildList {
            ...
            add(fx("sqrt", 1, "of 9", call("sqrt", DOUBLE, dbl(9.0))))
            add(fx("sqrt", 1, "of negative (NaN)", call("sqrt", DOUBLE, dbl(-4.0))))
            add(fx("sqrt", 1, "of 0", call("sqrt", DOUBLE, dbl(0.0))))
            add(fx("exp", 1, "of 0", call("exp", DOUBLE, dbl(0.0))))
            add(fx("exp", 1, "of 1", call("exp", DOUBLE, dbl(1.0))))
            add(fx("ln", 1, "of 1", call("ln", DOUBLE, dbl(1.0))))
            add(fx("ln", 1, "of 0 (-Infinity)", call("ln", DOUBLE, dbl(0.0))))
            add(fx("ln", 1, "of negative (NaN)", call("ln", DOUBLE, dbl(-1.0))))
            add(fx("ln", 1, "of e", call("ln", DOUBLE, dbl(Math.E))))
            add(fx("log2", 1, "of 8", call("log2", DOUBLE, dbl(8.0))))
            add(fx("log2", 1, "of 0 (-Infinity)", call("log2", DOUBLE, dbl(0.0))))
            add(fx("log10", 1, "of 1000 (NOT bare log)", call("log10", DOUBLE, dbl(1000.0))))
            add(fx("log10", 1, "of negative (NaN)", call("log10", DOUBLE, dbl(-1.0))))
            ...
            add(fx("asin", 1, "of 0", call("asin", DOUBLE, dbl(0.0))))
            add(fx("asin", 1, "out of domain (NaN)", call("asin", DOUBLE, dbl(2.0))))
            add(fx("acos", 1, "of 1", call("acos", DOUBLE, dbl(1.0))))
            add(fx("acos", 1, "out of domain (NaN)", call("acos", DOUBLE, dbl(-2.0))))
            add(fx("asin", 1, "boundary", call("asin", DOUBLE, dbl(-1.0))))
